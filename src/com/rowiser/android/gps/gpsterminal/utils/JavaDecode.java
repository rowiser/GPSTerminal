...
public class JavaDecode {
     ...
     * @param beginPos int
     * @param len      int
     * @param LHorder  boolean 低位在前，高位在后 －－true | 高位在前，低位在后为false
     * @return int
     */
    ...
    public static final String byteArray2String(byte[] b, int offset, int len) {
