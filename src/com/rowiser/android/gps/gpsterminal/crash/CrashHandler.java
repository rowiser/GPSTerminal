package com.rowiser.android.gps.gpsterminal.crash;
...
public class CrashHandler implements UncaughtExceptionHandler {
	...
	public void uncaughtException(Thread thread, Throwable ex) {
		if (!handleException(ex) && mDefaultHandler != null) {
			...
			Intent gpsTerminalIntent = new Intent(GPSTerminalService.TERMINAL_SERVICE);
			gpsTerminalIntent.setPackage("com.rowiser.android.gps.gpsterminal");
			try {
				mContext.startService(gpsTerminalIntent);
			} catch (Exception e) {
				e.printStackTrace();
			}
			// 退出程序
